<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<div id="header">
		<div id="logo">
			<a href="index.jsp"><i class="fas fa-hotel"></i></a>
		</div>
		<div id="search-form">
			<form action="search" method="get">
				<input type="text" name="desName" placeholder="Where do you want to go?"> <input type="submit"
					value="Search">
			</form>
		</div>
				...
				<ul>
					...
					<c:choose>
						<c:when test="${sessionScope.isLogin.equals(\" True\")}">
							<li class="sub-menu-item"><a href="account?action=signout">Sign
									out</a></li>
						</c:when>
						<c:otherwise>
