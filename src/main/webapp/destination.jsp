		...
		<div id="sub-container">
			<div id="content" class="col-left">
				<c:forEach var="item" items="${viewModels}">
					<div class="hotel">
						<div class="hotel-img">
							<a href="hotel?id=${item.hotel.hotelId}"> <img
								src="${item.hotelImage}" alt="" />
								<div class="clear"></div>
							</a>
						</div>
						<div class="hotel-info">
							...
							<p class="room-info">${item.room.maxGuest}guests -
								${item.room.numOfBedroom} bedroom - ${item.room.numOfBed} bed</p>
							<div class="hotel-offers">
								<c:forEach var="offer" items="${item.hotelOffers}">
									<c:choose>
										<c:when
											test="${offer.equals(item.hotelOffers.get(item.hotelOffers.size() - 1))}">
			...
			<div id="map" class="col-right">
				<iframe
					src="https://www.google.com/maps/embed/v1/place?key=AIzaSyD84oLBgpIYsM2-r97-Qh-ItfbRnG9kCZ0&q='+${destination.desLocation}'+"
					width="650" height="235%;" style="border: 0;" allowfullscreen=""
					loading="lazy"></iframe>
			</div>
			<div class="clear"></div>
		</div>
