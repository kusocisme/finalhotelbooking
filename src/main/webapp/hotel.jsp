...
<script src="https://kit.fontawesome.com/90c8120d4c.js"
	...
	<div id="house-body">
		...
		<div id="address">
			...
			<form action="wishlist" method="get">
				<input type="hidden" name="hotelId"
					value="${viewModel.hotel.hotelId}"> <input type="hidden"
					name="action" value="add"> <i class="fas fa-heart"></i>&nbsp;<input
		...
		<div style="height: 420px;">
			<div class="image-grid">
				<img id="pic1" class="image-grid-col-2 image-grid-row-2"
					src="${viewModel.hotelImages.get(0)}" alt="Hotel Image"> <img
					id="pic2" src="${viewModel.hotelImages.get(1)}" alt="Hotel Image">
				<img id="pic3" src="${viewModel.hotelImages.get(2)}"
					alt="Hotel Image"> <img id="pic4"
					src="${viewModel.hotelImages.get(3)}" alt="Hotel Image"> <img
					id="pic5" src="${viewModel.hotelImages.get(4)}" alt="Hotel Image">
			</div>
		</div>
		...
		<div class="row">
				...
				<div id="main-Description">
					<div>
						...
						<ul id="subHouse" style="margin-bottom: 0px;">
							...
							<li><span class="_1lmky0y" aria-hidden="true">- </span>${viewModel.room.numOfBedroom}
								bedroom</li>
							<li><span class="_1lmky0y" aria-hidden="true">- </span>${viewModel.room.numOfBed}
								bed</li>
						</ul>
					</div>
						...
						<c:forEach var="hotelOffer" items="${viewModel.hotelOffers}">
							<div class="offer">
								<c:choose>
									...
									<c:when
										test="${hotelOffer.equals(\"Long term stays allowed\")}">
										<i class="fas fa-calendar-week"></i>
									</c:when>
									<c:when
										test="${hotelOffer.equals(\"Security cameras on property\")}">
									...
									<c:when
										test="${hotelOffer.equals(\"Free parking on premises\")}">
			...
			<div class="column right"
				style="margin-left: 100px; margin-top: 50px;" id="box-column">
				<div id="box" class="arc">
					<form id="reserveForm" action="booking" method="POST">
						...
						<div class="room-price">
							<input type="hidden" id="hotel-price"
								value="${viewModel.room.pricePerNight}" disabled />
						...
						<div class="row" id="box-row">
							<div class="column left" id="box-left">
								<div class="check" id="check-in">
									<label for="start">CHECK-IN:</label> <input
										onchange="inputedDate()" type="date" class="check-date"
										id="start-date" name="tripStart" min="2021-01-01"
										max="2022-12-31">
								</div>
							</div>
							<div class="column right" id="box-right">
								<div class="check" id="check-out">
									<label for="start">CHECK-OUT:</label> <input
										onclick="alert_date()" onchange="updateGuest()" type="date"
										class="check-date" id="end-date" name="tripEnd"
										min="2021-01-01" max="2022-12-31">
								</div>
							</div>
						</div>
						<div id="box-guest" onclick="displayGuest()">
							<label for="start">GUEST - MAXIMUM: <input type="number"
								style="width: 20px; font-size: 12px; outline: none; font-weight: 600; background: white; border: none; margin: 2px;"
								readonly="true" name="countGuest" id="show-guest"
								value="${viewModel.room.maxGuest}" />
							</label> <input
								style="outline: none; background: white; border: none; margin: 2px;"
								readonly="true" name="guestDetail" id="guestDetail"
								value="0 Adults - 0 Children"></input>
						...
						<div class="sub-menu-reserve">
							...
							<ul>
								<li class="number"><p>Adults</p>
									...
									<div class="form">
										<div class="value-button" id="decrease0"
											onclick="decreaseValue()" value="Decrease Value">-</div>
										<input type="number" id="number" value="0" />
										<div class="value-button" id="increase0"
											onclick="increaseValue()" value="Increase Value">+</div>
									</div></li>
								<li class="number"><p>Children</p>

									<div class="form">
										<div class="value-button" id="decrease2"
											onclick="decreaseValue2()" value="Decrease Value">-</div>
										<input type="number" id="number2" value="0" />
										<div class="value-button" id="increase2"
											onclick="increaseValue2()" value="Increase Value">+</div>
									</div></li>
							</ul>
							<p class="mess">${viewModel.room.maxGuest}guests maximum.
								Infants do not count toward the number of guests.</p>
						</div>
						<div class="form-reserve">

							<button type="submit" class="btn-reserve"
								id="btn-reserve-booking" onclick="alert_pick()">Reserve</button>
							<div style="display: flow-root;">
								<input type="hidden" name="detailPrice"
									id="detail-price-caculated"
									style="margin-top: 25px; display: inline; float: left; background: white; border: none; outline: none;"
									readonly="true"></input> <input type="hidden" name="totalPrice"
									id="total-price-caculated"
									style="margin-top: 25px; display: inline; float: right; background: white; border: none; text-align: end; outline: none;"
									readonly="true"></input>
							</div>
							<div style="display: flow-root;">
								<input type="hidden" name="detailFee" id="detail-fee-caculated"
									style="margin-top: 4px; display: inline; float: left; background: white; border: none; outline: none;"
									readonly="true"></input> <input type="hidden" name="totalFee"
									id="total-fee-caculated"
									style="margin-top: 4px; display: inline; float: right; background: white; border: none; text-align: end; outline: none;"
									readonly="true"></input>
							</div>

							<div id="hrCalculate" style="display: none;"
								class="horizontal-line"></div>

							<div style="display: flow-root; margin-top: 5px;">
								<input type="hidden" name="detailTotal"
									id="detail-total-caculated"
									style="margin-top: 4px; display: inline; float: left; background: white; border: none; font-weight: bold; outline: none;"
									readonly="true"></input> <input type="hidden" name="totalTotal"
									id="total-total-caculated"
									style="margin-top: 4px; display: inline; float: right; background: white; border: none; font-weight: bold; text-align: end; outline: none;"
									readonly="true"></input>
		...
		<div id="hotel-map">
			...
			<p>${viewModel.hotel.hotelLocation}</p>
			<iframe
				src="https://www.google.com/maps/embed/v1/place?key=AIzaSyD84oLBgpIYsM2-r97-Qh-ItfbRnG9kCZ0&q='+${viewModel.hotel.hotelLocation}'+"
